...
- Work:
  ...
  - Treat any future capital-adjustment snapshots as external cash flows so deposits are not reported as investment return.
...
- Acceptance criteria:
  ...
  - The comparison view reconciles to BigQuery ledgers and computes return from each clean `$10,000` paper seed.
