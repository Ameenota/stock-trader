...
### 5. Make cron runs idempotent and use stable decision times
...
### 6. Build a coherent walk-forward simulator and promotion gate
...
### 7. Replace equal-weight concentration with portfolio risk sizing
...
### 8. Correct technical-signal definitions and data timing
...
### 9. Track position age by lots instead of last top-up
...
### 10. Improve sentiment data quality and prove incremental value
...
### 11. Strengthen operational observability and reconciliation
