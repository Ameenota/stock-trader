...
Your proposal must output a list of TargetAllocation objects under the `allocations` key. You must also output the final signals and theses for all watchlist assets under the `decisions` key, and a concise, 1-2 line user-facing summary of the final decision and rationale under the `summary` key (e.g., "Maintained positions in MU (28.3%) and MRVL (31.7%), keeping 40% cash because other watchlist assets failed technical entry conditions").
"""
...
class AnalystProposal(BaseModel):
    ...
    summary: str = Field(description="A concise, 1-2 line user-facing summary of the final decision and rationale (e.g., what was bought/sold/held/maintained and why).")
